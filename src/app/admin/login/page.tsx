      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">تسجيل دخول صالون ريم</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {/* حقل اسم المستخدم */}
            <div>
              <label className="block text-white/80 text-sm font-medium mb-2">اسم المستخدم</label>
              <input
                type="text"
                value={username}
            ...
            <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
              ...
              <p className="text-blue-200 text-xs text-center">
                المستخدم: <code className="bg-white/20 px-2 py-1 rounded">admin</code> | كلمة
                المرور: <code className="bg-white/20 px-2 py-1 rounded">admin123</code>
              </p>
            </div>
