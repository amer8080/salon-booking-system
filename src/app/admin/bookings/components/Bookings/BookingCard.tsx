...
export default function BookingCard({
  ...
  return (
    <div className={`fixed inset-0 z-50 flex ${positionClasses} justify-center bg-black bg-opacity-50 backdrop-blur-sm`}>
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* هيدر الكرت */}
        <div className={`px-6 py-4 border-b border-gray-200 ${
          isEmptySlot ? 
            (isBlocked ? 'bg-red-50' : 'bg-green-50') : 
            'bg-purple-50'
        }`}>
        ...
        <div className="p-6">
          ...
          {isEmptySlot && !isBlocked && (
            <div className="text-center py-4">
              ...
              <p className="text-gray-600 mb-4">
                يمكنك إنشاء حجز جديد في هذا الوقت
              </p>
            </div>
          )}
          ...
          {isBlocked && (
            <div className="text-center py-4">
              ...
              <p className="text-gray-600 mb-4">
                هذا الوقت غير متاح للحجز حالياً
              </p>
            </div>
          )}
