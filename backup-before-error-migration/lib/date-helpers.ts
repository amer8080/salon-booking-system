 ...
 */
export function getPreviousWeekRange(currentStartDate: string): {
  startDate: string;
  endDate: string;
} {
 ...
 * التنقل للشهر السابق
 */
export function getPreviousMonthRange(currentStartDate: string): {
  startDate: string;
  endDate: string;
} {
  const current = parseIstanbulDate(currentStartDate);
 ...
 * التنقل للشهر التالي
 */
export function getNextMonthRange(currentStartDate: string): {
  startDate: string;
  endDate: string;
} {
  const current = parseIstanbulDate(currentStartDate);
 ...
 */
export function buildBookingsApiUrl(
  startDate: string,
  endDate: string,
  view: 'week' | 'month' | 'day',
): string {
